...
export default function Home() {
  return (
    <section
      id="home"
      className="relative flex flex-col-reverse md:flex-row items-center justify-between min-h-screen text-white px-8 md:px-24 pt-24"
    >
      <div className="z-10 flex-1">
        <motion.h1
          initial={{ opacity: 0, y: -30 }}
        ...
        <motion.p
          ...
          className="mt-4 text-gray-400 max-w-2xl"
        >
          Backend Developer focused on writing clean, maintainable code in{' '}
          <span className="text-cyan-300">Python</span> &{' '}
          <span className="text-cyan-300">JavaScript</span> — with scalable APIs built using{' '}
          <span className="text-cyan-300">FastAPI</span> and{' '}
          <span className="text-cyan-300">Django</span>. <br />
          Also experienced with frontend dev using <span className="text-cyan-300">React</span> &{' '}
        ...
        >
          I am a{' '}
          <Typewriter
            words={['Python Developer.', 'FastAPI Specialist.', 'React Developer.', 'AI Enthusiast.']}
            loop={0}
            cursor
            cursorStyle="_"
            typeSpeed={70}
